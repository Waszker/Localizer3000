...
public class CoordinatesConverter {
	...
	public static String convertLocationToString(Context context, 
		...
		String selectedType = context.getSharedPreferences(
				MainActivity.SHARED_PREFERENCES, Context.MODE_PRIVATE)
				.getString(MainActivity.COORDINATES_TYPE, "Degrees"); 
		
		if(selectedType.contentEquals(context.getResources()
				.getStringArray(R.array.coordinateSystem)[0]))
		{
			DecimalFormat f = new DecimalFormat("0.#####");
			text.append(f.format(latitude) + "\u00B0 \n" + 
						f.format(longitude)	+ "\u00B0 \n");
		}
		else if(selectedType.contentEquals(context.getResources()
				.getStringArray(R.array.coordinateSystem)[1]))
		{
